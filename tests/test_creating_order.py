...
class TestCreatingOrder:
    ...
    @pytest.mark.parametrize('order_body', [OrderData.ORDER_BODY_BLACK, OrderData.ORDER_BODY_GREY, OrderData.ORDER_BODY_BLACK_GREY, OrderData.ORDER_BODY_NO_COLOUR])

...
class TestCreatingCourier:
    ...
    def test_failed_creating_courier_empty_login(self):
        registration_request = ApiYandexSamokat.creation_courier(TestAuthorizationData.REGISTRATION_COURIER_BODY_EMPTY_LOGIN)
    ...
    def test_failed_registration_courier_empty_password_error_code(self):
        registration_request = ApiYandexSamokat.creation_courier(TestAuthorizationData.REGISTRATION_COURIER_BODY_EMPTY_PASSWORD)
    ...
    def test_failed_registration_courier_empty_firstname_error_code(self):
        registration_request = ApiYandexSamokat.creation_courier(TestAuthorizationData.REGISTRATION_COURIER_BODY_EMPTY_FIRSTNAME)
    ...
    def test_failed_registration_courier_not_all_fields(self):
        registration_request = ApiYandexSamokat.creation_courier(TestAuthorizationData.REGISTRATION_COURIER_BODY_NOT_ALL_FIELDS)
